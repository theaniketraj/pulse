...
The following is a set of guidelines for contributing to Pulse Dashboard. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
