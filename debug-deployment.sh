...
echo "Expected GitHub Pages URL: https://theaniketraj.github.io/pulse/"
echo ""
echo "If assets have /pulse/ prefix → CORRECT"
...
echo "   (Assets will 404 because they expect /pulse/ path)"
echo ""
